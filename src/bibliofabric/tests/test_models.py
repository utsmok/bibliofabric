...
class DummyUnwrapper(ResponseUnwrapper):
    ...
    def unwrap_single_item(self, response_json: dict[str, Any]) -> dict[str, Any] | None:
...
class ValidUnwrapperImpl(ResponseUnwrapper):
    ...
    def unwrap_single_item(self, response_json: dict[str, Any]) -> dict[str, Any] | None: return None
    def get_next_page_token(self, response_json: dict[str, Any]) -> str | None: return None
    def get_total_results(self, response_json: dict[str, Any]) -> int | None: return None
